      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="<?= base_url('games/edit/' . $game['id']) ?>" class="btn btn-warning btn-sm">
                <i class="fas fa-pencil-alt"></i>
              </a>

              <a href="javascript:goDelete(<?= $game['id'] ?>, 'games')" class="btn btn-danger btn-sm">
